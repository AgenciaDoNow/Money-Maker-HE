...
import {
  ...
  addProject, deleteProject, subscribeProjects,
} from "./db";
import {
...
export default function App() {
  ...
  const handleAddProject = async (name, icon, description, goal) => {
    try {
      await addProject({ name, icon, description, goal, createdAt: new Date().toISOString() });
  ...
  return (
    <div className="login-screen">
      <div className="login-header">
        ...
        <p className="login-sub">Control financiero familiar · Do Now</p>
      </div>
